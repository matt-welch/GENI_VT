...
The transmission or packetization delay for transmitting or receiving a large 1500 byte packet would be 1.214 µs which should be well within the measurement noise.

% section experimental_procedure (end)

\nocite{rathore2013kvm}
