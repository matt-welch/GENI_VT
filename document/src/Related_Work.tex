...
This section will describe some of the work in the field of virtualization that has brought virtualization to the current state of the art.
Some of the subsystems in Linux and processor hardware that enable virtualization will also be discussed in this section.
...
\label{sec:vm_arch}
In the following sections, virtual machine architecture will be discussed illustrate the resource needs and potential improvements available.
...
Paravirtualizaion has its fans, however, and much work has been done previously comparing Xen to containers and other hypervisors such as KVM \autocite{_felter_1, _younge_1, _wang_1, _che_1, _scheepers_1, _wang_2, rathore2013kvm}.
...
\begin{figure}
    \centering
    \includegraphics[width=150mm]{dockerarchitecture.png}
    \caption{Docker ecosystem architecture}
    \label{fig:dockerecosystem}
\end{figure}
The ecosystem of docker is what makes it so powerful \autocite{dockerecosystem}.  
In Figure~\ref{fig:dockerecosystem}, the overall flow of a container is shown.  
