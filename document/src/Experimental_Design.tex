...
Linux \texttt{iptables} may also have a negative impact on network performance, but it is kept part of the configuration since it represents the default networking configuration of Docker.
